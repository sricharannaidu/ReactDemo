  ...
  render() {
    ...
    return (
      <Grid verticalAlign="middle" textAlign="center">
        <Grid.Column>
          <Header style={{ marginTop: 12 }} color="teal" as="h1" icon>
            <Icon name="history" />
            <Header.Content>Login to Software Estimation tool</Header.Content>
          </Header>
            ...
            {!this.isOAuth() && (
              ...
              <Button fluid size="large" color= 'teal' id="login-btn">{btnLabel}</Button>
          </Form>
        </Grid.Column>
      </Grid>
    );
